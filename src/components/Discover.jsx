...
function DiscoverMore({windowSize}) {
  ...
  return (
    <MainContainer>
      <HeadingContainer>
        <div>
          <Heading variant="h3">Discover More NFTs</Heading>
          <Caption variant="body1">Explore new trending NFTs</Caption>
        </div>
        <div>
          <RankingButton
            text="See All"
